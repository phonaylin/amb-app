...
import com.amb.bus.BusOrderItem;
...
class JacksonCustomizations {
	...
	public @Bean Module ambModule() {
		return new AmbModule();
	}

	@SuppressWarnings("serial")
	static class AmbModule extends SimpleModule {

		public AmbModule() {

			setMixInAnnotation(BusOrder.class, AmbModule.OrderMixin.class);
...
//			setMixInAnnotation(CreditCard.class, CreditCardMixin.class);
		...
		static abstract class OrderMixin {
			...
			@JsonCreator
			public OrderMixin(Collection<BusOrderItem> lineItems) {}
		}
