...
-- Core entities
insert into poi(id, title, description, version) values(1, 'Yangon', 'Yangon', 1);
insert into poi(id, title, description, version) values(2, 'Mandalay', 'Mandalay', 1);
insert into poi(id, title, description, version) values(3, 'Inle', 'Inle', 1);
insert into poi(id, title, description, version) values(4, 'Bagan', 'Bagan', 1);
insert into poi(id, title, description, version) values(5, 'Pyin Oo Lwin', 'Pyin Oo Lwin', 1);
insert into poi(id, title, description, version) values(6, 'Naypyitaw', 'Naypyitaw', 1);
insert into poi(id, title, description, version) values(7, 'Taunggyi', 'Taunggyi', 1);


------

--CUSTOMER
insert into customer(id, first_name, last_name, email_address, contact_number, version) values(1, 'Nay Lin', 'Aung', 'phonaylin@gmail.com', '+6582011660', 1);
insert into customer(id, first_name, last_name, email_address, contact_number, version) values(2, 'Maverick Lin', 'Aung', 'phonaylin@yahoo.com', '+6582011661', 1);

-- BUS

-- bus operators
insert into bus_operator (id, name, version) values (1, 'Shwe Mandalay', 1);
insert into bus_operator (id, name, version) values (2, 'E-lite', 1);
insert into bus_operator (id, name, version) values (3, 'Shwe Inle', 1);
insert into bus_operator (id, name, version) values (4, 'Chan Myae', 1);
insert into bus_operator (id, name, version) values (5, 'All Star', 1);
insert into bus_operator (id, name, version) values (6, 'Shwe Nandaw', 1);;

-- buses
insert into bus (id, license_number, capacity, bus_class, bus_class_description, operator_id, version) values (1, '9F/***', 10, 'Normal', 'Express Bus 2+2', 1, 1);
insert into bus (id, license_number, capacity, bus_class, bus_class_description, operator_id, version) values (2, '9F/***', 20, 'First Class', 'Express Bus with large seat 2+1', 1, 1);
insert into bus (id, license_number, capacity, bus_class, bus_class_description, operator_id, version) values (3, '9F/***', 20, 'VIP', 'VIP Express Bus 2+1', 1, 1);
insert into bus (id, license_number, capacity, bus_class, bus_class_description, operator_id, version) values (4, '9F/***', 20, 'VIP', 'VIP Express Bus 2+1', 2, 1);

insert into bus_amenities (bus_id, bus_amenities, bus_amenities_order) values (1, 'AIRCON', 0);
insert into bus_amenities (bus_id, bus_amenities, bus_amenities_order) values (1, 'MOVIE', 1);
insert into bus_amenities (bus_id, bus_amenities, bus_amenities_order) values (1, 'TOWEL', 2);
insert into bus_amenities (bus_id, bus_amenities, bus_amenities_order) values (2, 'AIRCON', 0);
insert into bus_amenities (bus_id, bus_amenities, bus_amenities_order) values (2, 'TOWEL', 1);
